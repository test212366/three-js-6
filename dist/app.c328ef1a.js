...
},{}],"img/image2.jpg":[function(require,module,exports) {
module.exports = "/image2.2068df52.jpg";
...
var _image2 = _interopRequireDefault(require("./img/image2.jpg"));
...
var Sketch = /*#__PURE__*/function () {
  function Sketch() {
    ...
    this.textures = [new THREE.TextureLoader().load(_image.default), new THREE.TextureLoader().load(_image2.default)];
    this.camera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.1, 3000);
    this.camera.position.z = 1000;
    this.mask = new THREE.TextureLoader().load(_mask.default);
    this.scene = new THREE.Scene();
    this.time = 0;
    this.move = 0; // this.controls = new OrbitControls(this.camera, this.renderer.domElement);
...
new Sketch();
},{"./shaders/fragment.glsl":"shaders/fragment.glsl","./shaders/vertex.glsl":"shaders/vertex.glsl","three-orbit-controls":"../../../node_modules/three-orbit-controls/index.js","./img/mask.png":"img/mask.png","./img/image.png":"img/image.png","./img/image2.jpg":"img/image2.jpg"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
